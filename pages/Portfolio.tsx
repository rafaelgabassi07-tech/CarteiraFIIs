...
import { Search, TrendingUp, TrendingDown, ArrowUpRight, ArrowDownRight, Building2, CandlestickChart, Wallet, Target, Activity, Leaf, ExternalLink } from 'lucide-react';
        ...
        {selectedAsset && (() => {
            ...
            <div className="p-6 pb-20">
                ...
                <div className="pt-4 border-t border-zinc-100 dark:border-zinc-800 anim-slide-up" style={{ animationDelay: '200ms' }}>
                     <div className="flex items-center gap-2 mb-2"><Leaf className="w-3.5 h-3.5 text-emerald-500" /><span className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Análise</span></div>
                     <p className="text-xs text-zinc-600 dark:text-zinc-300 leading-relaxed font-medium mb-3">{selectedAsset.sentiment_reason || 'Dados fundamentais atualizados via Investidor10 (Scraper).'}</p>
