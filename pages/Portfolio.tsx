...
const PortfolioComponent: React.FC<PortfolioProps> = ({ portfolio, balance = 0, privacyMode = false }) => {
    ...
    return (
        <div className="anim-fade-in">
             ...
             <div className="sticky top-[52px] z-30 bg-primary-light dark:bg-primary-dark py-4 -mx-4 px-4 mb-3 anim-fade-in border-b border-zinc-100 dark:border-zinc-800/50">
