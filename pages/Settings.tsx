          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-zinc-900 p-8 rounded-2xl border border-zinc-100 dark:border-zinc-800 text-center overflow-hidden">
                ...
                <div className="flex items-center justify-center gap-2 mb-8 relative select-none">
                    ...
                    <span class="font-display text-[48px] font-black tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-br from-zinc-700 via-zinc-500 to-zinc-800 dark:from-white dark:via-zinc-200 dark:to-zinc-400 mt-2 -ml-1">
                        NVEST
                    </span>
                </div>
