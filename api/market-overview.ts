...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    try {
        // Fallback robusto: sempre retorna EMERGENCY_DATA para garantir que a UI não quebre
        // Em um cenário real, aqui entraria lógica de scraping ou cache database
        const rawData = EMERGENCY_DATA;
        ...
        return res.status(200).json({ // Retorna 200 mesmo com erro interno para garantir fallback no client se estruturado
            error: true, 
